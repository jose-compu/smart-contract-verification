...
| `verification/certora/` | Certora CVL rules for `SimpleBank` |
| `.github/workflows/test.yml` | `fmt`, build, tests, 100% coverage gate, Certora typecheck |
...
The Certora experiment is [`verification/certora/`](verification/certora/): CVL rules checked against compiled `SimpleBank` bytecode ([docs.certora.com](https://docs.certora.com/)).
