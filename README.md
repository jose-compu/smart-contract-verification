...
The Why3 experiment is [`verification/why3/`](verification/why3/): the same vault, with proof obligations discharged by Alt-Ergo ([why3.org](https://www.why3.org/)). It is not a check of `src/SimpleBank.sol`.
...
- **Why3** — Deductive platform with pluggable solvers. The model is [`verification/why3/`](verification/why3/). Alt-Ergo discharges the obligations; the EVM gap is trusted.
...
| `verification/why3/` | Automated deductive / SMT | Why3 |
